...
const GetTask = ({ date }) => {
  ...
  const url = `https://pure-atoll-99669.herokuapp.com/all-tasks/${formattedDate}`;
  ...
  return (
    <div className="mt-10">
                    ...
                    <thead>
                      <tr className="border-b border-gray-200 font-thin bg-white leading-4 tracking-wider text-base text-gray-500">
                        <th className="px-6 py-5 text-left" colSpan="100%">
                          <p>{formattedDate} Assigned Task List</p>
                        </th>
                      </tr>
                      ...
                      {data.map((task) => (
                        <tr key={task._id}>
                          ...
                          <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div className="flex flex-col items-center justify-center">
                              <div>
                                <p className="text-left">{task.employeeID}</p>
                              </div>
                              <div className="ml-4">
                                <div>
                        ...
                        <tr key={task._id}>
                          <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div className="text-sm leading-5 text-gray-900">
                              <div className="flex flex-col items-center justify-center">
                                <div>
                                  <h1>Name: {task.employeeName}</h1>
                                  <h1>ID: {task.employeeID}</h1>
                                </div>
                              </div>
                            </div>
                          </td>
      ...
      {modalData && (
        <TaskDetailsModal modalData={modalData} setModalData={setModalData} />
      )}
    </div>
  );
};
