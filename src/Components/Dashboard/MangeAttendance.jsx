    ...
    <div className="w-full min-h-screen px-1 bg-gray-100 my-5 md:mb-10 lg:pt-8">
              ...
              <table className="min-w-full table-auto">
                <thead>
                  ...
                  <tr className="bg-gray-50 border-b border-gray-200 text-xs leading-4 text-gray-500 uppercase tracking-wider">
                    ...
                    <th className="px-6 py-3  font-medium text-center">Employee ID</th>

                    <th className="px-6 py-3 text-center font-medium">Attendance</th>
                  </tr>
                </thead>
                    ...
                    <tr key={employee._id}>
                      ...
                      <td className="px-6 py-4 whitespace-no-wrap text-center border-b border-gray-200 text-sm leading-5 font-medium">
                        <div className="flex justify-center items-center">
                          {employee.attendances?.includes(formattedDate) ? (
                            <span className="btn  btn-disabled btn-success text-white rounded uppercase font-poppins font-medium">Present</span>
                          ) : (
                            <span
      ...
      {employeData.length === 0 ? (
        <div className=" w-full my-10 z-50 overflow-hidden  opacity-75 flex flex-col items-center justify-center">
          <div className="spinner-border animate-spin inline-block text-teal-600 mb-10 w-14 h-14 border-6 rounded-full" role="status"></div>
          <div className=" mt-10">
            <LoadingData />;
          </div>
        </div>
