...
const AdminLogin = ({ setReload }) => {
  ...
  const handleLoginFormSubmit = async (e) => {
    ...
    if (employeeID && password) {
      fetch(`https://pure-atoll-99669.herokuapp.com/admin-login`, {
        method: "POST",
        headers: {
        ...
        <div className="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
          <div className="p-4 py-6 text-white bg-blue-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
            ...
            <p className="mt-6 font-normal capitalize text-center text-gray-300 md:mt-0">
              Hello admin, Login for Manage all employee. If you are an admin we
              give you an Login ID and Password. Enter your admin ID and
              Password for Login.
            </p>
